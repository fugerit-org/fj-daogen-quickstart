...
@Stateless
@Path("/person/load")
public class LoadPerson extends org.fugerit.java.daogen.quickstart.config.ServiceProviderHelper<ModelPerson> {

	// custom code start ( code above here will be overwritten )
	// custom code end ( code below here will be overwritten )

	private static final long serialVersionUID = 762819242511L;
